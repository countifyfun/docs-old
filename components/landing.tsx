    ...
    <div className="max-w-[90rem] mx-auto p-6 min-h-[calc(100vh-var(--nextra-navbar-height))] flex w-full flex-col">
      <div className="flex flex-col md:flex-row gap-4 grow">
        <div className="flex flex-col text-center md:text-left items-center md:items-start justify-center gap-3">
          ...
          <a
            href="/invite"
            className="bg-gradient-to-b from-yellow-300 to-yellow-500 px-3 py-1 rounded-md hover:opacity-75 transition-all text-black"
          >
            Add Countify to your Discord server
          </a>
        </div>
